...
def Liaison_model5(N_init, sampleN):
    ...
    np.savetxt('AdjMatrices/L/new5/L'+str(N_init)+'_'+str(sampleN)+'.txt', A, fmt='%10.f', delimiter='\t') 

    with open('StructuralProperties/ClusteringCoeff/L/new5/L'+str(N_init)+'.txt', "a") as text_file:
        text_file.write(str(nx.average_clustering(Gclique)) + "\n")

    with open('StructuralProperties/AveShortestPath/L/new5/L'+str(N_init)+'.txt', "a") as text_file:
        text_file.write(str(nx.average_shortest_path_length(Gclique)) + "\n")

    with open('StructuralProperties/Density/L/new5/L'+str(N_init)+'.txt', "a") as text_file:
    ...
    with open('StructuralProperties/DegreeDist/L/new5/L'+str(N_init)+'.txt', "a") as text_file:
...
#Gclique = Liaison_model5(N_init, sampleN)
Gclique = Liaison_model5(50, 0)
